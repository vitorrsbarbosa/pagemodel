...
class CheckoutPage {
	...
	nextDayOption: Selector;
	nextShippingBtn: Selector;
	nextPaymentBtn: Selector;
	nextConfirmBtn: Selector;
	confirmOrderBtn: Selector;
	orderConfirmationMessage: Selector;
	viewOrderDetailsLink: Selector;
	constructor() {
